...
def set_local_file_permissions(
    ...
    :param logger: Optional logger instance
    :raises DagsterError: If permission setting fails
    """
    logger = logger or logging.getLogger(__name__)
...
def verify_tpt_utility_on_remote_host(
    ...
    :param logger: Optional logger instance
    :raises DagsterError: If utility is not found or verification fails
    """
    logger = logger or logging.getLogger(__name__)
...
def decrypt_remote_file(
    ...
    :raises DagsterError: If decryption fails
    """
    logger = logger or logging.getLogger(__name__)
    ...
    if windows_remote:
        ...
        password_escaped = password.replace(
            '"', '""'
        )  # Escape double quotes for Windows
        decrypt_cmd = (
...
def transfer_file_sftp(
    ...
    :param logger: Optional logger instance
    :raises DagsterError: If file transfer fails
    """
    logger = logger or logging.getLogger(__name__)
