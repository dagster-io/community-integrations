...
"""
    ...
    assert instance.compute_log_manager._bucket == mock_s3_bucket.name  # noqa: SLF001  # ty: ignore
    assert instance.compute_log_manager._prefix == s3_prefix  # noqa: SLF001  # ty: ignore
